...
- The library must contain exactly 25 original, 27 variant, and 25 new problems. Two variants were added on 2026-09-23: `the-balance-lock` (a follow-up to Runes on the Castle Door) and its easier warm-up `under-the-limit`, authored by `scripts/author-balance-lock.js` and `scripts/author-under-the-limit.js`.
