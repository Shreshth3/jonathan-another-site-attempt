...
assert.equal(specs.length, 27, "Step 5 needs exactly 27 variant lessons");
assert.equal(new Set(specs.map(spec => spec.id)).size, 27, "Duplicate Step 5 lesson");
...
console.log(`Validated Step 5 content: ${count} single-bug questions across 27 variants.`);
